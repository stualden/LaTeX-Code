...
%\begin{tabbing}
%\rightline{Name: \rule[-0.1cm]{5cm}{0.01cm} \hspace{2.5in} \=  \\
%    \rightline{Name: \rule[-0.1cm]{5cm}{0.01cm} }

%\rhead[{Name:\enspace\makebox[2in]{\hrulefill}}]{}

% Finance - Financial Mathematics\\
% Section 1-A - Simple Interest and Simple Discount
%\end{tabbing}
...
\begin{questions}
    ...
    \question Eighty days after borrowing money, you pay back \$850.  How much was originally borrowed
    ...
    \question Mr. Johnson owes \$500 due in 4 months and \$700 due in 9 months.  If money is worth
              11\% simple annual interest, what \underline{single} payment \underline{6}  months from now would liquidate his debts?
              \vspace{2in}

    \question Mrs. Johnson has two options for repaying her loan
    \begin{itemize}
        \item \$200 at 5 monbths and \$300 at 10 months, or
