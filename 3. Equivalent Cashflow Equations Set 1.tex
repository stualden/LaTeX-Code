...
% Equivalent Cashflow Equations Set 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{questions}
  ...
  \mathproblem[][1.5in]{
    A debt of \$5,000 is due 5 years from now.  It is proposed instead that $\$X$ be paid now
    and another $\$X$ be paid 10 years from now.  Calculate the value of $X$ if the annual
    interest rate is 12\%.
  }

  \mathproblem[][2.75in]{
    A man stipulates in his will that \$50,000 from his estate is to be placed in a fund
  ...
  \mathproblem[][1.5in]{
    John is repaying a debt with payments of \$250 per month at the end of each month.  If he misses his
