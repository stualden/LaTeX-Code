...
Solving for j we get 0.061678, or about 6.1678\%.  Note that the effective annual rate (6.1678\%) is \underline{higher} than the
nominal rate (6\%), due to more frequent compounding.
