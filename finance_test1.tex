...
\textbf{Instructions:}
\begin{itemize}
  \item Answer all multiple-choice questions by selecting the best answer.
  \item Answer all short-response questions clearly.
  \item Show all work for financial math questions.
\end{itemize}
...
\begin{questions}
  ...
  \begin{choices}
    ...
    \choice They are only availablefor those age 21 and older
  ...
  \question[10]
  % Your math problem goes here

  \begin{parts}
    \part Set up the equation or formula:

    \vspace{1.2in}

    \part Solve and interpret the result:
