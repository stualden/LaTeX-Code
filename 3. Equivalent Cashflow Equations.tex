...
One particularly nice behavior of compound interest is that you get the same equivalence results
...
\begin{center}
  \begin{tikzpicture}[scale=1]
    ...
    % \draw at (3,0) node[below=6pt] {3};


    % \draw (6,0) node[below=3pt] {$ 6 $} node[above=3pt] {$ -\$50 $};
    % %    \draw node[below=6pt] at (6,0) {6} node[above=3pt] {$ -\$50 $};
